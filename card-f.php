            ...
            <div class="container">
                <div class="bg-fluide-glaz">
                    <div class="wrapper-inf float-end ">
                        ...
                        <p class="peptide-text">Легкая, быстро впитывающаяся гелевая сыворотка, которая заметно уплотняет и увлажняет кожу, поддерживая здоровый вид кожного барьера.</p>
                        <br>
                        <p class="peptide-text peptide-text-m">Та же формула глазури, но теперь в нашей новой упаковке с глазурью с головы до ног. Объем: 50 мл / 1,7 унции.</p>
